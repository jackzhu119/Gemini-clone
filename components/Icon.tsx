...
export const SparkleIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="url(#gemini-gradient)" className={className}>
    <defs>
      <linearGradient id="gemini-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
        <stop offset="0%" style={{ stopColor: '#4b90ff', stopOpacity: 1 }} />
        <stop offset="100%" style={{ stopColor: '#ff5546', stopOpacity: 1 }} />
      </linearGradient>
    </defs>
